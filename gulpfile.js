...
gulp.task('fonts', function() {
    return gulp.src(paths.src + paths.fonts + '/**/*.{eot,ttf,svg,woff}')
...
gulp.task('watch', function() {
    ...
    watch(paths.src + paths.fonts + '/**/*.{eot,ttf,svg,woff}', function() {
        gulp.start('fonts');
    });
});

gulp.task('dev', ['scss', 'less', 'html', 'js', 'js:vendor', 'images','fonts'], function() {
    browserSync.init({
        server: paths.dest
    });
    gulp.start('watch');
